...
## Q1 visualization - no shiny needed. poster? my opinion is no need to show, as the x axis (year) is different - only show findings in poster
...
## Q2 visualization -1st shiny. poster: show below fig3 and name a few transaction examples as finding
...
## Q3 visualization (2nd shiny: can do plotly and show all 4 years / all years in 1 plot? poster: show 4 plots)
...
## Q4 visualization(3rd shiny, poster: show 2)
...
# Conclusion - list out top 3? overlapping nodes as conclusion - shall be monitored closely in future work

find out all the overlap nodes from Q1-4
